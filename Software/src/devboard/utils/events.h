...
#define EVENTS_ENUM_TYPE(XX)                 \
  ...
  XX(EVENT_TESLA_CP_ALERTS_001_016)          \
  XX(EVENT_TESLA_CP_ALERTS_001_016_BAT2)     \
  XX(EVENT_TESLA_CP_ALERTS_001_016_BAT3)     \
  XX(EVENT_TESLA_CP_ALERTS_017_032)          \
  XX(EVENT_TESLA_CP_ALERTS_017_032_BAT2)     \
  XX(EVENT_TESLA_CP_ALERTS_017_032_BAT3)     \
  XX(EVENT_TESLA_CP_ALERTS_033_048)          \
  XX(EVENT_TESLA_CP_ALERTS_033_048_BAT2)     \
  XX(EVENT_TESLA_CP_ALERTS_033_048_BAT3)     \
  XX(EVENT_TESLA_CP_ALERTS_049_064)          \
  XX(EVENT_TESLA_CP_ALERTS_049_064_BAT2)     \
  XX(EVENT_TESLA_CP_ALERTS_049_064_BAT3)     \
  XX(EVENT_TESLA_CP_ALERTS_065_080)          \
  XX(EVENT_TESLA_CP_ALERTS_065_080_BAT2)     \
  XX(EVENT_TESLA_CP_ALERTS_065_080_BAT3)     \
  XX(EVENT_TESLA_CP_ALERTS_081_096)          \
  XX(EVENT_TESLA_CP_ALERTS_081_096_BAT2)     \
  XX(EVENT_TESLA_CP_ALERTS_081_096_BAT3)     \
  XX(EVENT_TESLA_CP_MISSING)                 \
  XX(EVENT_TESLA_CP_MISSING_BAT2)            \
  XX(EVENT_TESLA_CP_MISSING_BAT3)            \
