...
class TeslaBattery : public CanBattery {
 ...
 protected:
  ...
  // During a guarded stop, request the same VCSEC unlock reason generated by
  // the physical charge-handle button. Byte 3 bits 0..4 are
  // VCSEC_lockRequestType=6 (PASSIVE_BLE_EXTERIOR_CHARGEHANDLEBUTTON_UNLOCK).
  static constexpr CAN_frame TESLA_CHARGE_339_RELEASE = {
      .FD = false,
      .ext_ID = false,
      .DLC = 8,
      .ID = 0x339,
      .data = {0x41, 0x44, 0xF8, 0x06, 0x00, 0x03, 0x80, 0x00}};
