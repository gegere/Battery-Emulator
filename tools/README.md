...
Run the Ingenext-focused analysis:

```sh
python3 tools/pcan_trace_analyzer.py TRACE_C_INGENEXT_CHARGE.trc
```
...
Ingenext trace shows that the actual enable transition also requires the
