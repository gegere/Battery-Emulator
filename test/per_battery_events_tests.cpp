...
const EVENTS_ENUM_TYPE kDriverEventBases[] = {
    ...
    EVENT_TESLA_CP_ALERTS_001_016,
    EVENT_TESLA_CP_ALERTS_017_032,
    EVENT_TESLA_CP_ALERTS_033_048,
    EVENT_TESLA_CP_ALERTS_049_064,
    EVENT_TESLA_CP_ALERTS_065_080,
    EVENT_TESLA_CP_ALERTS_081_096,
    EVENT_TESLA_CP_MISSING,
};
